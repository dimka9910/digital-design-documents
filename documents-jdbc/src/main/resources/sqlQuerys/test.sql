...
SELECT D.id as id, D.name as name, d.type_of_file as type_of_file,
...
JOIN DOCUMENT D on CAD.DOCUMENT_id = D.id WHERE CATALOGUE.id = 1;
...
JOIN CATALOGUE C on C.id = CAC.CATALOGUE_children_id WHERE CATALOGUE.id = 1;
...
DELETE FROM CATALOGUE WHERE id = 8;
...
INSERT INTO CATALOGUE_AND_DOCUMENT (CATALOGUE_id, DOCUMENT_id) VALUES (1,1),(1,2),(1,3);
INSERT INTO CATALOGUE_AND_CATALOGUE (CATALOGUE_id, CATALOGUE_children_id) VALUES (1,2),(1,3),(1,4);

SELECT * FROM CATALOGUE_AND_CATALOGUE